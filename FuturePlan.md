...
### Key Features
- Periodic SSL certificate checks for specified endpoints (configurable interval, default 1 day)
- Alerting when certificates are approaching expiration (e.g., 30 days, 7 days, 1 day)
- Integration with existing alerting system (email notifications)
